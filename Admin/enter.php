...
<div class="modal-dialog" style="margin-top:200px;">
    ...
    <div class="modal-header">
        <h4 class="modal-title text-success">Вход</h4>
    </div>
    <div class="modal-body">
    <form method="POST">
        <div class="form-group">
        <label for="login" class="text-success">Логин</label>
        <input type="text" name="login" id="login" class="form-control">
        </div>
        <div class="form-group">
        <label for="pass" class="text-success">Пароль</label>
        <input type="password" name="pass" id="pass" class="form-control">
        </div>
    </form>
    </div>
    <div class="modal-footer">
        <button type="button" class="btn btn-success" id="btn-enter">Войти</button>
      </div>
</div>
<script src='https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js'></script>
<script src='../Scripts/Admin/enter.js'></script>
</body>
</html>
ENTER;
